...
impl FriWitnessGeneratorDal<'_, '_> {
    ...
    pub async fn create_aggregation_jobs(
    ...
    ) {
        {
            ...
            sqlx::query!(
                "INSERT INTO scheduler_dependency_tracker_fri (l1_batch_number, status, created_at, updated_at) \
        ...
        sqlx::query!(
                "   UPDATE leaf_aggregation_witness_jobs_fri \
                     ...
                     WHERE (l1_batch_number, circuit_id) IN ( \
                            ...
                            GROUP BY prover_jobs_fri.l1_batch_number, \
                                     prover_jobs_fri.circuit_id, \
